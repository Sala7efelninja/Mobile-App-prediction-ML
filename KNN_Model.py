# -*- coding: utf-8 -*-
"""
Created on Thu Dec 19 19:43:22 2019
...
x_trainPca,x_testPca,ratio=pp.apply_PCA(X_train,X_test,90)
...
#plt.figure(figsize=(12, 6))
#plt.plot(range(1, 60), accuracy, color='red', linestyle='dashed', marker='o',
#        markerfacecolor='blue', markersize=10)
#plt.title('Error Rate K Value')
#plt.xlabel('K Value')
#plt.ylabel('Acc')
